...
<head>
            ...
            <div class="swiper-wrapper mb-5">
                ...
                <div class="swiper-slide bg-white p-4">
                    ...
                    <p>
                        ...
                        Quasi fugiat sint blanditiis temporibus molestias qui rerum porro,
                        quidem earum? Distinctio!
                    </p>
                    <div class="rating">
                            <i class="bi bi-star-fill text-warning"></i>
                            <i class="bi bi-star-fill text-warning"></i>
    ...
    <?php 
        if(isset($_GET['account_recovery']))
        {
            ...
            $query = select("SELECT * FROM `user_cred` WHERE `email`=? AND `token`=? AND `t_expre`=? LIMIT 1",
