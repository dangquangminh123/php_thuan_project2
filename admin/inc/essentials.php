<?php 
    ...
    define('SITE_URL','http://127.0.0.1:8080/hjwebsite/');
   ...
   // define('FEATURES_IMG_PATH',SITE_URL.'images/features/');
    ...
    define('UPLOAD_IMAGE_PATH',$_SERVER['DOCUMENT_ROOT'].'/hjwebsite/images/');
  ...
  //  define('FEATURES_FOLDER','features/');
    ...
    //sendgrid api key
    define('SENDGRID_API_KEY',"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");
    define('SENDGRID_EMAIL',"dangquangminhdn86@gmail.com");
    define('SENDGRID_NAME',"MinhPhp WEBDEV");
